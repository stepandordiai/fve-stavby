        ...
        <section className="advantages">
            ...
            <ul className="advantages-list">
                <li className="advantages-item">
                    ...
                    <div className="dd-wrapper dd-wrapper--active">
                        <p className="dd-details">
                            Na dalku kontrolujeme stav kazdeho panelu a pokud
                            nektery potrebuje opravit, ihned to vime. Rychle a
                            efektivne pak zaridime opravu.
                        </p>
                    </div>
                </li>
                <li className="advantages-item">
                    ...
                    <div className="dd-wrapper">
                        <p className="dd-details">
                            ...
                            prenasime vznikle prebytky tam, kde vam co nejlepe
                            poslouzi. Vetsinou primo do firmy.
                        </p>
                    </div>
                </li>
                <li className="advantages-item">
                    ...
                    <div className="dd-wrapper">
                        <p className="dd-details">
                            ...
                            pozarucni servis diky tomu zajistujeme 24/7 v kazdem
                            regionu.
                        </p>
                    </div>
                </li>
                <li className="advantages-item">
                    ...
                    <div className="dd-wrapper">
                        <p className="dd-details">
                            ...
                            nainstalujeme a fotovoltaiku spustime. Postarame se
                            i o nasledny servis.
                        </p>
                    </div>
                </li>
                ...
                <li className="advantages-item">
                    ...
                    <div className="dd-wrapper">
                        <p className="dd-details">
                            Na panely a optimizery poskytujeme zaruku 25 let, na
                            stridace SolarEdge az 20 let a na konstrukce 20 let.
                        </p>
                    </div>
                </li>
            </ul>
