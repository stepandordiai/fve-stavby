            ...
            <div className={styles["advantages"]}>
                <div className={styles["advantages-card"]}>
                    <div className={styles["advantages-card__wrapper"]}>
                        ...
                        <p className={styles["advantages__desc"]}>
                            Se solární energií si můžete zajistit předvídatelné
                            náklady na elektřinu na roky dopředu
                        </p>
                    </div>
                ...
                <div className={styles["advantages-card"]}>
                    ...
                    <p className={styles["advantages-card__desc"]}>
                        Solární energie vytváří o 91 % méně znečištění CO2 než
                        zemní plyn a o 96 % méně CO2 než uhlí
                    </p>
                ...
                <div className={styles["advantages-card"]}>
                    ...
                    <p className={styles["advantages-card__desc"]}>
                        Čistá solární energie nám poskytuje neomezené spolehlivý
                        zdroj energie
                    </p>
