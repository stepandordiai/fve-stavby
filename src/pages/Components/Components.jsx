					...
					<div className="inverter-container">
						...
						<div>
							...
							<ul className="component-list">
								...
								<li>
									Stejnosměrné a střídavé propojení pro modernizaci stávajícího
									solárního systému
								</li>
					...
					<div className="inverter-container">
						...
						<div>
							...
							<ul className="component-list">
								...
								<li>Podpora paralelního připojení různých výkonových měničů</li>
								<li>Podpora nabíjení/vybíjení baterie podle nastavení času</li>
								<li>
					...
					<div className="inverter-container">
						...
						<div>
							...
							<ul className="component-list">
								...
								<li>Provozní teplota: Nabíjení: 0-55℃ / Vybíjení: -20℃-55℃</li>
								<li>Skladovací teplota: 0℃-35℃</li>
								<li>Vlhkost: 5%-95%</li>
								<li>Záruka : 10 let</li>
								<li>Průtok energie: 20 MWh při 70% EOL (konec životnosti)</li>
								<li>Certifikace: UN38.3, IEC62619, CE, CEI 0-21, VDE2510-50</li>
					...
					<div className="inverter-container">
						...
						<div>
							...
							<ul className="component-list">
								...
								<li>
									Komunikační rozhraní RS485 baterie-BMS, CAN-BUS systém-střídač
								</li>
				...
				<div className="components-container" id="panels">
					...
					<div className="inverter-container">
						...
						<div>
							...
							<ul className="component-list">
								<li>
									Technologie N-Type umožňuje vyšší účinnost, nižší degradaci a
									delší životnost panelů
								</li>
								<li>
								...
								<li>
									Nízká degradace, s roční mírou degradace pouze 0,4 % během 30
									let po prvním roce.
								</li>
								<li>
									12letá záruka na výrobek | 30letá záruka na lineární napájení
								</li>
							</ul>
						</div>
					</div>
					...
					<div className="inverter-container">
						...
						<div>
							...
							<ul className="component-list">
								...
								<li>
									Zároveň jsou díky použité technologii vizuálně atraktivnější,
									a proto se skvěle hodí na střechy rodinných domů
								</li>
